...
This module helps maintain consistency in your resource names for Terraform. The goal is to enable you to easily compose names for each resource that requires one in Terraform, ensuring uniformity across your resources and repositories.
...
| <a name="output_data_protection_backup_vault"></a> [data\_protection\_backup\_vault](#output\_data\_protection\_backup\_vault) | Data Protection Backup Vault |
...
| <a name="output_databricks_access_connector"></a> [databricks\_access\_connector](#output\_databricks\_access\_connector) | Databricks Access Connector |
...
| <a name="output_eventhub_cluster"></a> [eventhub\_cluster](#output\_eventhub\_cluster) | Eventhub Cluster |
...
| <a name="output_monitor_alert_processing_rule_action_group"></a> [monitor\_alert\_processing\_rule\_action\_group](#output\_monitor\_alert\_processing\_rule\_action\_group) | Monitor Alert Processing Rule Action Group |
...
| <a name="output_resource_group_template_deployment"></a> [resource\_group\_template\_deployment](#output\_resource\_group\_template\_deployment) | Resource Group Template Deployment |
...
| <a name="output_route_filter"></a> [route\_filter](#output\_route\_filter) | Route Filter |
| <a name="output_route_server"></a> [route\_server](#output\_route\_server) | Route Server |
...
| <a name="output_subnet_service_endpoint_storage_policy"></a> [subnet\_service\_endpoint\_storage\_policy](#output\_subnet\_service\_endpoint\_storage\_policy) | Subnet Service Endpoint Storage Policy |
...
| <a name="output_virtual_machine_restore_point_collection"></a> [virtual\_machine\_restore\_point\_collection](#output\_virtual\_machine\_restore\_point\_collection) | Virtual Machine Restore Point Collection |
